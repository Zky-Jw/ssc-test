...
const headers = ref([
	{ text: "Nama kategori", value: "category", sortable: true, fixed: true, width: 200 },
...
// console log serviceCategory with composition API
    ...
    <BreezeAuthenticatedLayout :page-title="pageTitle">
			<template #header>
				<h2 class="font-semibold text-xl text-gray-800 leading-tight">
					Create or just look for the Service Category
				</h2>
			</template>
		<div class="">
				...
				<div class="bg-white overflow-hidden shadow-md sm:rounded-lg">
					<div class="bg-white border-b border-gray-200">
						<div className="flex items-center justify-between py-7 px-10">
							<div class="">
								<h3 class="text-primary-400 text-center">Service Category List</h3>
							</div>
							<ButtonCreate button-text="Create Category" create-route="category.create"></ButtonCreate>
						</div>
						<div class="flex flex-col">
							<div class="-m-1.5 overflow-x-auto">
								<div class="p-1.5 min-w-full inline-block align-middle">
									<div id="category_list" class="overflow-hidden">
										<div class="min-w-full divide-y divide-gray-300">
											...
											<EasyDataTable buttons-pagination :headers="headers" :items="props.serviceCategory"
												...
												<template #item-id="item">
													<div
														...
														<ButtonAction :item="item" edit-route="category.edit" :form="form" delete-route="category.destroy" />
													</div>
												</template>

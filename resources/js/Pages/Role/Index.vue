...
// console log role with composition API
const headers = ref([
	{ text: "Nama Role", value: "role", sortable: true, fixed: true, width: 200 },
	...
	<BreezeAuthenticatedLayout :page-title="pageTitle">
		<template #header>
			<h2 class="font-semibold text-xl text-gray-800 leading-tight">
				Create or just look for the role
			</h2>
		</template>
		<div class="">
				...
				<div class="bg-white overflow-hidden shadow-md sm:rounded-lg">
					<div class="bg-white border-b border-gray-200">
						<div className="flex items-center justify-between py-7 px-10">
							<div class="">
								<h3 class="text-primary-400 text-center">Role List</h3>
							</div>
							<ButtonCreate button-text="Create Role" create-route="role.create"></ButtonCreate>
						</div>
						<div class="flex flex-col">
							<div class="-m-1.5 overflow-x-auto">
								<div class="p-1.5 min-w-full inline-block align-middle">
									<div id="role_list" class="overflow-hidden">
										<div class="min-w-full divide-y divide-gray-300">
											...
											<EasyDataTable buttons-pagination :headers="headers" :items="props.role" class="w-full px-8"
												show-index alternating :search-value="searchValue">
												<template #item-id="item">
													<div class="whitespace-nowrap text-sm font-medium text-primary-300">
														<ButtonAction :item="item" edit-route="role.edit" :form="form" delete-route="role.destroy" />
													</div>
												</template>
